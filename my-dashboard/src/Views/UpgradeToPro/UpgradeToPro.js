        ...
        <Card>
          <CardHeader color="info">
            <h4 className={classes.cardTitleWhite}>
              Dashboard PRO Siam-Sci
            </h4>
            <p className={classes.cardCategoryWhite}>
              Mais informações e dados para seu negócio? Seja Premium
            </p>
          </CardHeader>
          <CardBody>
              ...
              <table className={classes.table}>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className={classes.center}>Somente R$199</td>
                  </tr>
                  <tr>
                    <td />
                    <td className={classes.center}>
                    ...
                    <td className={classes.center}>
                      <Button
                        round
                        color="danger"
                        href="https://www.fmmagalhaes.com.br"
                      >
                        Atualizar para Pro
                      </Button>
                    </td>
